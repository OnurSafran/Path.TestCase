...
COPY test/Path.TestCase.IntegrationTest/Path.TestCase.IntegrationTest.csproj ./test/Path.TestCase.IntegrationTest/
COPY test/Path.TestCase.UnitTest/Path.TestCase.UnitTest.csproj ./test/Path.TestCase.UnitTest/
RUN dotnet restore
...
COPY test/Path.TestCase.IntegrationTest/. ./Path.TestCase.IntegrationTest
COPY test/Path.TestCase.UnitTest/. ./Path.TestCase.UnitTest
